...
class MetricsSmall(Button):
    def __init__(self, **kwargs):
        ...
        # Remove temperature widget from MetricsSmall
        self.temp = SingularMetricSmall("temp", "TEMP", icons.temp) if visible.get('temp', True) else None
